...
from app.routers import auth, admin, weather, agent, mcp, mcp_data_agent, mcp_analysis_agent
...
app.include_router(mcp_analysis_agent.router)  # MCP 分析 Agent HTTP 包装
